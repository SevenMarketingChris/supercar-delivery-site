export default function SupercarSilhouette({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 800 300" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      {/* Supercar side profile - Lamborghini-style wedge shape */}
      <path
      ...
      {/* Side intake */}
      <path
        d="M440 170 L480 168 L520 170 L520 185 L480 183 L440 185 Z"
        fill="none"
        stroke="currentColor"
        strokeWidth="1"
        opacity="0.3"
